...
javatest: java
	java -ea -jar tools/java_api/third_party/junit-platform-console-standalone-1.9.3.jar \
...
pytest: | python install
	...
	PYTHON_KUZU_PATH=${ROOT_DIR}/install/lib/python python3 -m pytest -v test_main.py
