...
TINY_SNB_KNOWS_PROPERTIES_GROUND_TRUTH = {
    (0, 2): {'date': datetime.date(2021, 6, 30),
             ...
             'summary': {'locations': ["'toronto'", "'waterloo'"], 'transfer': {'day': datetime.date(2021,1,2), 'amount': [100, 200]}},
             'notes': {'tag': 1}},
    ...
    (0, 5): {'date': datetime.date(2021, 6, 30),
             ...
             'notes': {'tag': 'nice weather'}},
    (2, 0): {'date': datetime.date(2021, 6, 30),
             'meetTime': datetime.datetime(1946, 8, 25, 19, 7, 22),
             'validInterval': datetime.timedelta(days=3750, seconds=46800, microseconds=24),
             'comments': ['2huh9y89fsfw23', '23nsihufhw723'],
             'summary': {'locations': ["'paris'"], 'transfer': {'day': datetime.date(2000,1,1), 'amount': [20, 5000]}},
             'notes': {'tag': 4}},
    (2, 3): {'date': datetime.date(1950, 5, 14),
             'meetTime': datetime.datetime(1946, 8, 25, 19, 7, 22),
             'validInterval': datetime.timedelta(seconds=1380),
             'comments': ['fwehu9h9832wewew', '23u9h989sdfsss'],
             'summary': {'locations': ["'paris'"], 'transfer': {'day': datetime.date(2011, 5, 1), 'amount': [2000, 5340]}},
             'notes': {'tag': 'cool stuff found'}},
    (2, 5): {'date': datetime.date(1950, 5, 14),
             'meetTime': datetime.datetime(2012, 12, 11, 20, 7, 22),
             'validInterval': datetime.timedelta(days=7232),
             'comments': ['fwh9y81232uisuiehuf', 'ewnuihxy8dyf232'],
             'summary': {'locations': ["'vancouver'"], 'transfer': {'day': datetime.date(2020, 1, 1), 'amount': [120, 50]}},
             'notes': {'tag': 'matthew perry'}},
    (3, 0): {'date': datetime.date(2021, 6, 30),
             ...
             'summary': {'locations': ["'london'", "'toronto'"], 'transfer': {'day': datetime.date(2012, 11, 21), 'amount': [223, 5230]}},
             'notes': {'tag': 10}},
    (3, 2): {'date': datetime.date(1950, 5, 14),
             ...
             'summary': {'locations': ["'paris'", "'beijing'"], 'transfer': {'day': datetime.date(2011, 3, 11), 'amount': [2323, 50]}},
             'notes': {'tag': 1}},
    ...
    (5, 0): {'date': datetime.date(2021, 6, 30),
             ...
             'comments': ['fwewe'],
             'summary': {'locations': ["'shanghai'", "'nanjing'"], 'transfer': {'day': datetime.date(1998, 11, 12), 'amount': [22, 53240]}},
             'notes': {'tag': 15}},
    ...
    (7, 8): {'date': datetime.date(1905, 12, 12),
             ...
             'summary': {'locations': ["'toronto'", "'thisisalongcityname'"], 'transfer': {'day': datetime.date(1930, 11, 22), 'amount': [18, 323]}},
             'notes': {'tag': 8}},
    (7, 9): {'date': datetime.date(1905, 12, 12),
             ...
             'summary': {'locations': ["'waterloo'"], 'transfer': {'day': datetime.date(2000, 1, 1), 'amount': [1000, 5000]}},
             'notes': {'tag': 10}}
}
